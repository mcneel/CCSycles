...
namespace ccl.ShaderNodes
{
	...
	public class BlendTextureProceduralNode : ShaderNode
	{
		...
		{
			CSycles.shadernode_set_member_bool(clientId, sceneId, shaderId, Id, Type, "UseBlendColor", UseBlendColor);
			CSycles.shadernode_set_member_float(clientId, sceneId, shaderId, Id, Type, "BlendFactor", BlendFactor);
		}
	}
}
